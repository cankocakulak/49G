...
static HashMap<String, FlowPreset> flowPresets = new HashMap<String, FlowPreset>() {{
  // More descriptive names and tuned values
  put("calm_flow", new FlowPreset(0.05, 0.001));    // Gentle, smooth movement
  put("storm_flow", new FlowPreset(0.2, 0.005));    // Chaotic, fast movement
  put("cosmic_flow", new FlowPreset(0.08, 0.002));  // Medium, swirling movement
